...
const Details = tw.div`p-6 rounded border-2 border-t-0 rounded-t-none border-dashed border-appcolor flex-1 flex flex-col items-center text-center lg:block lg:text-left`;
...
export default ({
  subheading = "",
  heading = <><span tw="text-appcolor">News Blog</span></>,
  description = "News updates will be featured here",
  ...
  const blogPosts = [
    {
      ...
      author: "Oga Mustapha Issa Toyin",
      category: "CEO",
