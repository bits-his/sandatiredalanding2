...
const ControlButton = styled.button`
  ${tw`mx-3 p-4 rounded-full transition duration-300 bg-gray-200 hover:bg-gray-300 text-appcolor hover:text-primary-700 focus:outline-none focus:shadow-outline`}
  svg {
    ${tw`w-4 h-4 stroke-3`}
  }
`;
  ...
  testimonials = [
    {
      ...
      heading: "",
      quote:
        "Before Sanda Ruwangida, I used to walk for up to 20 minutes per trip to fill up a total of 5 carts per day. Now I can fill up to 20 carts because I only need to walk for 5 minutes per trip",
      customerName: "Yunusa",
      customerTitle: "",
    },
  ],
