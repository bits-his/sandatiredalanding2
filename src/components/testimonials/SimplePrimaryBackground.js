...
const PrimaryBackgroundContainer = tw(Container)`-mx-8 px-8 bg-appcolorfaded text-gray-100`;
...
const QuoteIcon = tw(QuoteIconBase)`absolute opacity-15 top-0 left-0 transform -translate-y-2 -translate-x-1/2 sm:-translate-x-full w-10 fill-current text-appcolor`
  ...
  testimonials = [
    {
      ...
      quote:
        "Before registering with Sanda Tireda, I had to close my shop every time I needed to go to the market. Now I have expanded my business and even hired an extra person"
